      ...
      <div className="w-full flex items-center justify-evenly gap-x-6 px-4 py-4 bg-white/60 backdrop-blur-2xl  border-b border-black/5 ">
        ...
        <div className="flex items-center space-x-8">
          <button
            ...
            className="px-4 py-2 text-primary font-semibold rounded-xl cursor-pointer"
          >
            Log in
          </button>
          <button
            ...
            className="px-4 py-2 text-white bg-primary hover:bg-gray-800 rounded-xl font-semibold text-sm flex items-center space-x-6 cursor-pointer"
          >
            <p>Sign Up</p>
